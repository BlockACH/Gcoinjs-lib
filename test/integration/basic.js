...
describe('gcoinjs-lib (basic)', function () {
  it('can generate a random gcoin address', function () {
    ...
    var keyPair = gcoin.ECPair.makeRandom({ rng: rng })
  ...
  it('can generate an address from a SHA256 hash', function () {
    var hash = gcoin.crypto.sha256('correct horse battery staple')
    var d = bigi.fromBuffer(hash)

    var keyPair = new gcoin.ECPair(d)
    var address = keyPair.getAddress()
  ...
  it('can import an address via WIF', function () {
    var keyPair = gcoin.ECPair.fromWIF('Kxr9tQED9H44gCmp6HAdmemAzU3n84H3dGkuWTKvE23JgHMW8gct')
    var address = keyPair.getAddress()
  ...
  it('can create a Transaction', function () {
    var keyPair = gcoin.ECPair.fromWIF('L1uyy5qTuGrVXrmrsvHWHgVzW9kKdrp27wBC7Vs6nZDTF2BRUVwy')
    var tx = new gcoin.TransactionBuilder()

    tx.addInput('aa94ab02c182214f090e99a0d57021caffd0f195a81c24602b1028b130b63e31', 0)
    tx.addOutput('1Gokm82v6DmtwKEB8AiVhm82hyFSsEvBDK', 15000, 1)
    tx.sign(0, keyPair)
